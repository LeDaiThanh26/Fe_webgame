...
const GameCard = forwardRef<HTMLDivElement, Props>(
  ({ image, video, title, slug, issidebar = false, isRecentPlay = false, gameId }, ref) => {
        ...
        <div className="relative transition-transform hover:scale-105">
          ...
          >
            <img
              src={image}
              alt={title}
              className={`w-full h-full object-cover absolute inset-0 transition-opacity duration-200 ${showVideo ? "opacity-0" : "opacity-100"}`}
            />
