...
import type { CommentData, Pagination } from "@/app/lib/types";
      ...
      {pagination.totalPages > 1 && (
        <div className="pagination">
          ...
          <span
            ...
            onClick={() =>
              pagination.currentPage > 1 && fetchComments(pagination.currentPage - 1)
            }
          >
            &lt;
          </span>
          <span
            style={{
              cursor:
                pagination.currentPage < pagination.totalPages ? "pointer" : "not-allowed",
