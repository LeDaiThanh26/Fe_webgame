...
export default function Sidebar({
    ...
    const recentGames = [...Array(8)].map((_, i) => ({
                ...
                <div className="flex flex-col h-full p-6">
                    ...
                    <div className="mb-8">
                        <div className="relative bg-white rounded-full shadow-lg mr-6">
                            ...
                            <input
                                ...
                                className="w-full pl-16 pr-14 py-4 rounded-full focus:outline-none text-gray-400 font-medium"
                            />
                            <button 
                    ...
                    {isSearchOpen  &&(
                        <button
                            ...
                            className="absolute top-6 -right-7 p-[14px] bg-white rounded-full hover:scale-110 transition-transform duration-200 shadow-md"
                        >
